...
OBJECTS = [
    ...
    ("quarry", "Vale Quarry", -13, 3, 0, ""),
    ("pickup",         "Log Pile",                -10,  3, 0, "wood"),
    ("pickup", "Cut Stone", -9, -3.5, 0, "stone"),
    ...
    ("pickup", "Hale Supply Cart", -3, -3, 0, "wood"),
    ("pickup", "Old Forge Stock", 1, -7, 0, "obsidian"),
    ...
    ("quest_giver",    "Aldren's Camp",             8, -5, 0, ""),
    ...
    ("pickup", "Pass Masons' Cache", 7, -6, 0, "stone"),
